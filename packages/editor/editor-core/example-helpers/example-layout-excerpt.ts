                  ...
                  content: [
                    {
                      type: 'text',
                      text:
                        '“Fixed width” problem is not just about a narrow line length. It’s also about flexibility, expressiveness, and discoverability of ways to structure pages that is currently missing from the editor.  ',
                    },
                  ],
                },
              ],
                  ...
                  content: [
                    {
                      type: 'text',
                      text:
                        'To solve this, we are going to add more column layout option, improve discoverability of layout, and implement a dense / wide mode. See ',
                    },
                    {
                      type: 'text',
                      text: 'plan of attack here. ',
                      marks: [
                        {
                          type: 'link',
                          attrs: {
                            href:
                              'https://product-fabric.atlassian.net/wiki/spaces/E/pages/885850254/Milestones+for+editor+density+improvements',
                          },
                        },
                      ],
                    },
