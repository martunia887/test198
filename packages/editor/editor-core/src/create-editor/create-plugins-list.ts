...
export function getDefaultPluginsList(props: EditorProps): EditorPlugin[] {
  const { appearance, textFormatting, placeholder, placeholderHints, placeholderBracketHint } = props;
  ...
  return [
    ...
    placeholderPlugin({ placeholder, placeholderHints, placeholderBracketHint }),
    clearMarksOnChangeToEmptyDocumentPlugin(),
    hyperlinkPlugin(),
