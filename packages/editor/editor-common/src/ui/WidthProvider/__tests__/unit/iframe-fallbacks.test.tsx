...
describe('Iframe fallbacks', () => {
  ...
  describe('IframeWidthDetectorFallbackWrapper', () => {
    describe('when there is support for ResizeObserver and IntersectionObserver', () => {
      it('should not add the IframeWidthDetectorFallback', () => {
        const wrapper = mount(
          <IframeWidthDetectorFallbackWrapper>
            <span>1</span>
          </IframeWidthDetectorFallbackWrapper>,
        ...
        const component = wrapper.find(IframeWidthDetectorFallback);
