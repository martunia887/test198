    ...
    return (
      <MediaClientConfigContext.Provider value={mediaClientConfig}>
        <div style={{ padding: 40 }}>
          ...
          <p>
            As a filmstrip user, I want to be able to navigate between link
            cards in the filmstrip. Previously, a bug was reported in filmstrip
            which prevented navigation within a filmstrip when it contained
            exclusively link items (
