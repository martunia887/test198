...
describe('isWebGLAvailable helper method', () => {
  it('should create only 1 canvas mediaClient and cache the return value from getContext', () => {
    const fn = jest.fn();
  ...
  it('should return false when the canvas mediaClient is not available', () => {
    const fn = jest.fn();
