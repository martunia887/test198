...
export default md`
  ## v9 to v10 [Better types edition]
...
`}
  ...
  This means that these kinds of code will break:
...
`}
  ...
  Now they're only typed according to the exports,
  which means only \`e100\`,
  \`e200\`,
  \`e300\`,
  \`e400\`,
  and \`e500\` are available.
