...
export const h900 = () => css`
  ${baseHeading(35, 40)} color: ${heading};
  font-weight: 500;
...
export const h800 = () => css`
  ${baseHeading(29, 32)} color: ${heading};
  font-weight: 600;
  letter-spacing: -0.01em;
...
export const h700 = () => css`
  ${baseHeading(24, 28)} color: ${heading};
  font-weight: 500;
  letter-spacing: -0.01em;
  margin-top: ${gridSize() * 5}px;
`;
...
export const h600 = () => css`
  ${baseHeading(20, 24)} color: ${heading};
  font-weight: 500;
...
export const h500 = () => css`
  ${baseHeading(16, 20)} color: ${heading};
  font-weight: 600;
...
export const h400 = () => css`
  ${baseHeading(14, 16)} color: ${heading};
  font-weight: 600;
...
export const h300 = () => css`
  ${baseHeading(12, 16)} color: ${heading};
  font-weight: 600;
...
export const h200 = () => css`
  ${baseHeading(12, 16)} color: ${subtleHeading};
  font-weight: 600;
  margin-top: ${gridSize() * 2}px;
`;
