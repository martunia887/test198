...
export type RatingItemRender = (props: {
  isChecked: boolean;
}) => React.ReactNode;
...
export interface InternalRatingItemProps extends RatingItemProps {
  /**
   * Render callback that should return a ReactNode.
   * Is passed an argument which is an object with one property `isChecked`.
   */
  render: RatingItemRender;
}

const RatingItem = forwardRef<HTMLLabelElement, InternalRatingItemProps>(
  (
