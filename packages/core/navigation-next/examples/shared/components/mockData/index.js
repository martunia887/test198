...
const mockUrls = ['/issues/nav-1', '/issues/nav-2'];
...
export function objectData(n: number): any[] {
  const items: any[] = [];
...
export function containerData(n: number): any[] {
  const items: any[] = [];
...
export function personData(n: number): any[] {
  const items: any[] = [];
