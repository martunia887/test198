  ...
  },
  {
    ...
    content: (
      <div>
        ...
        {md`
          where ValueType is of interface **string**, and ActionMeta is an object of the following shape
        `}
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        {code`(ValueType, ActionMeta) => void`}
        {md`
where ValueType is of the interface
        `}
        {code`
        { [string]: any } |
        Array<{ [string]: any }> |
        ...
        undefined`}
        {md`
and ActionMeta is of the interface object with the following shape
        `}
        {code`
        {
      ...
      `}
        {md`
          **Note** removedValue exists only when the action is of interface "remove-value" or "pop-value"
        `}
      </div>
    ),
    packages: ['single', 'multi'],
