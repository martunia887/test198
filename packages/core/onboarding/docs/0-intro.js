...
export default md`
  ...
  ${(
    <Props
      ...
      props={require('!!extract-react-types-loader!../components/Spotlight')}
    />
  )}
  ...
  ${(
    <Props
      ...
      props={require('!!extract-react-types-loader!../components/SpotlightCard')}
    />
  )}
  ...
  ${(
    <Props
      ...
      props={require('!!extract-react-types-loader!../components/Modal')}
    />
  )}
